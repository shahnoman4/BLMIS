...
export default class BranchTopTenNoOfEmp extends React.Component{
    ...
    componentDidMount(){
        ...
        busy.apps = true;
        this.setState({busy});
        api.get('/report/branchtoptenNoOfEmp')
             .then(response=>{
                    busy.apps = false;
            ...
            <div className="col p3040">
                <Bar
                  ...
                  options={{
                    title:{
                      display:true,
                      text:'Top 10 branches with respect to number of personal to be employed Graph',
                      fontSize:20
                    },
                    legend:{
                      display:true,
                        ...
                        <div className="data-heading">
                            <div className="d-flex">
                                <div className="mr-auto">
                                    <h5>Top 10 branches with respect to number of personal to be employed
                                    </h5>
                                </div>
                            </div>
                        </div>
