...
class BranchGuide extends React.Component{
    ...
    constructor(props){
        ...
        this.istlist=[
            ...
            "Copy of Contract/Agreement with following information clearly indicating in the document & duly flagged/annexed:",
             {
                child :[
                    "Contract Agreement: Name of Project/work",
             ...
             <div className="row">
                <div className="col-md-8">
                    <div className="content-wraper">
                        <h2>Information and Required Documents for Permission of  Branch  Office</h2>
