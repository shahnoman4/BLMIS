...
export default class Fees extends Validateable {
  ...
  render() {
    ...
    if (this.state.status === "success") {
      // console.log("OLD COMPANTY-->>",this.company.branch);
      return (
        <Congrats
          //test data
          id={this.props.uid ? this.props.uid : this.props.profile.company.uid}
        />
      );
    } else {
      return (
  ...
  return (
    <div className="iframe-container">
      ...
      <div className="tab-content tab-content-front form-group">
        <div className="tab-pane active" id="pay-creditcard">
          <div className="row">
            <div className="col">
              {props.preview ? (
        ...
        <ContextForm target={this}>
          <div className="tab-pane" id="pay-manual">
            <div className="row">
              <div className="col">
                <div className="form-group">
    ...
    <div className="widget widget-postForm text-success m-auto text-center">
      <div className="widget-inner__">
        ...
        <div className="postForm-msg">
          <p>
            Your request for Branch Office against application ID{" "}
